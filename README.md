...
2.计算各维度对应 Arxiv 发表至今的月均结果，即：![a](https://latex.codecogs.com/svg.latex?a), ![b](https://latex.codecogs.com/svg.latex?b), ![c](https://latex.codecogs.com/svg.latex?c), ![d](https://latex.codecogs.com/svg.latex?d)。
...
3.计算各维度的细项评分，即![S_a](https://latex.codecogs.com/svg.latex?S_a)，![S_b](https://latex.codecogs.com/svg.latex?S_b)，![S_c](https://latex.codecogs.com/svg.latex?S_c)，![S_d](https://latex.codecogs.com/svg.latex?S_d)，以![S_a](https://latex.codecogs.com/svg.latex?S_a)为例，如下公式中![a_max](https://latex.codecogs.com/svg.latex?a_%7Bmax%7D)，![a_avg](https://latex.codecogs.com/svg.latex?a_%7Bavg%7D)，![a_min](https://latex.codecogs.com/svg.latex?a_%7Bmin%7D)，分别表示该方向（如目标检测）下所有算法中a的最大值，算数平均值与最小值。
...
4.计算该模型的影响力总体得分，即![S](https://latex.codecogs.com/svg.latex?S)：
